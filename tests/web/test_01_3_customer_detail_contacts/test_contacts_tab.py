...
Covers: tab panel visibility, Add/Delete Contact buttons, search,
status/location filters, contacts data grid (columns, summary, Field Selector,
Create Filter / Filter Builder), row actions (Edit/Delete), pagination.
"""
import pytest
import re
...
class TestContactsTab:
    ...
    Usage:
        pytest tests/web/test_01_3_customer_detail_contacts/test_contacts_tab.py -v
    """
