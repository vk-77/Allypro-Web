"""
Customer Details - Service Activity work order Billing/Disposal/Labor tab tests.

Validates PO Numbers, Payment, Billing Status, Add/Edit/Delete charge lines,
Add/Edit/Delete disposal rows, disposal status popup, and disposal audit history.
"""
import pytest
