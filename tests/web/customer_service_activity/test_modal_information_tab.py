"""
Customer Details - Service Activity work order Information tab tests.

Validates Destination, Priority, and Order Note updates, Location Detail
and Map display, and Operations Results panel on the Information tab.
"""
import re
import pytest
