"""
Customer Details - Service Activity calendar order modal tests.

Validates opening the work order modal from a calendar event, header
field validation, Send SMS, Send Email, Print Order, Close button,
and Status dropdown behaviour.
"""
import re
import pytest
