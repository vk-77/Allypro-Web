...
class TestServiceInfoTransferService:
    ...
    Usage:
        pytest tests/web/test_01_2_customer_details_information/test_service_info_transfer_service.py -v
    """

    @pytest.mark.skip(reason="Complex multi-step flow - matches Cypress it.skip")
