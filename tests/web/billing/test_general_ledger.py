...
Validates exporting detail and summary files, completing batches,
exporting from the Export Batch tab, and testing filters with
multiple report types and route selections.
"""
import pytest
...
class TestGeneralLedger:
    ...
    Usage:
        pytest tests/web/billing/test_general_ledger.py -v
    """
