...
Validates the Update Routing modal headers, Effective Date field, Day
and Route selection for all rows, and Process Updates submission.
"""
import pytest
...
class TestServiceInfoUpdateRouting:
    ...
    Usage:
        pytest tests/web/customer_information/test_service_info_update_routing.py -v
    """
