"""
Customer Details - Service Info header button tests.

Validates the Info icon dropdown, hamburger menu options, and header
action buttons on the Service Info widget.
"""
import pytest
...
class TestServiceInfoHeaderButtons:
    ...
    Usage:
        pytest tests/web/customer_information/test_service_info_header_buttons.py -v
    """
