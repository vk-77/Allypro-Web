"""
Customer Pages - activity reminders tests.

Validates updating an existing activity reminder description by
selecting a user, loading reminders, editing, and saving.
"""
import pytest
...
class TestActivityReminders:
    ...
    Usage:
        pytest tests/web/customer_pages/test_activity_reminders.py -v
    """
