...
Validates adding services to routing by selecting records, choosing
a day of week and route, and submitting the routing queue workflow.
"""
import pytest
...
class TestRoutingQueue:
    ...
    Usage:
        pytest tests/web/operations/test_routing_queue.py -v
    """
