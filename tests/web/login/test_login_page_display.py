"""
Login page display and layout tests.

Verifies UI elements including logos, field icons, login button,
EULA modal content and dismiss behavior, and copyright notice.
"""
...
class TestLoginPageDisplay:
    ...
    Usage:
        pytest tests/web/login/test_login_page_display.py -v
    """
