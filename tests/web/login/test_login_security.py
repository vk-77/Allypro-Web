"""
Login page security and availability tests.

Checks that the login page is served over HTTPS with a masked password
field, and that failed login attempts keep the user on the login page
...
class TestLoginSecurityAndAvailability:
    ...
    Usage:
        pytest tests/web/login/test_login_security.py -v
    """
