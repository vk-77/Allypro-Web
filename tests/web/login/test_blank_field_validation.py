"""
Login page blank field validation tests.

Confirms that submitting the login form with missing company, email,
or password fields triggers the correct inline error messages.
"""
import pytest
...
class TestBlankFieldValidation:
    ...
    Usage:
        pytest tests/web/login/test_blank_field_validation.py -v
    """
