...
Validates billing cycle dropdown selection, load and clear behavior,
column format and tooltip verification, and the auto-apply payment
credit confirmation and processing workflow.
"""
import re
import pytest
...
class TestAutoApply:
    ...
    Usage:
        pytest tests/web/receivables/test_auto_apply.py -v
    """
