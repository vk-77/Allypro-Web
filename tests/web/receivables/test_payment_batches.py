...
Validates grid column display, data loading, date and status filters,
clear button reset, action icon availability, empty result handling,
and navigating into batch detail views.
"""
import pytest
...
class TestPaymentBatches:
    ...
    Usage:
        pytest tests/web/receivables/test_payment_batches.py -v
    """
